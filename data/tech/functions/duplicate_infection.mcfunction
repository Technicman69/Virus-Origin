summon silverfish ~ ~0.1 ~ {Tags:[tech.infection, tech.copy],Silent:true,Attributes:[{Name:"generic.movement_speed",Base:0.3f},{Name:"generic.attack_damage",Base:5f},{Name:"generic.attack_knockback",Base:0.7f}]}
