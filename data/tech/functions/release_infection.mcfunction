summon silverfish ~ ~ ~ {Tags:[tech.infection],Health:15,Attributes:[{Name:"generic.movement_speed",Base:0.3f},{Name:"generic.attack_damage",Base:4f},{Name:"generic.attack_knockback",Base:0.7f},{Name:"generic.max_health",Base:10f}]}
