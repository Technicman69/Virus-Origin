scoreboard players set %random count 0
execute if predicate tech:50_50 run scoreboard players add %random count 1
execute if predicate tech:50_50 run scoreboard players add %random count 2
execute if predicate tech:50_50 run scoreboard players add %random count 4
execute if predicate tech:50_50 run scoreboard players add %random count 8
execute if predicate tech:50_50 run scoreboard players add %random count 16
execute if predicate tech:50_50 run scoreboard players add %random count 32
# 78 - (32 + 16 + 8 + 4 + 2 + 1) = 15
execute if predicate tech:50_50 run scoreboard players add %random count 15
...
execute if score %random count matches 6 run summon zombie_villager ~ ~ ~ {Tags:[tech.corrupted_id]}
execute if score %random count matches 58 run summon zombified_piglin ~ ~ ~ {Tags:[tech.corrupted_id]}
